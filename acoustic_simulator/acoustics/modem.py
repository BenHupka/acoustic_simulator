...
class modem:
    ...
    def update(self, position, soundwaveList, sim_time, SOS, dst):
        ...
        self.update_soundwave_list(soundwaveList)
        self.update_sos(SOS)
        ret = None
    ...
    #Helpfunction
    def real_distance(self, receivingTime, AnchorPosition):
    ...
    def set_published_flag(self, bool):
        self.publishFlag = bool

    def send_poll(self, dst):
