...
class plot():
    ...
    def plotMeas(self, meas_data):
        ...
        plt.figure(1)
        plt.subplot(4, 1, 1)
        plt.scatter(self.time1,
                    self.Err1,
                    color="y",
                    label="Anchor 1 simulated")
        ...
        plt.subplot(4, 1, 2)
        plt.scatter(self.time2,
                    self.Err2,
                    color="b",
                    label="Anchor 2 simulated")
        ...
        plt.subplot(4, 1, 3)
        plt.scatter(self.time3,
                    self.Err3,
                    color="g",
                    label="Anchor 3 simulated")
        ...
        plt.subplot(4, 1, 4)
        plt.scatter(self.time4,
                    self.Err4,
                    color="r",
                    label="Anchor 4 simulated")
